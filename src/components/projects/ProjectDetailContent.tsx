...
export function ProjectDetailContent({
  ...
  return (
    <div className={variant === "modal" ? "pt-24 pb-24" : "pt-32 pb-24 min-h-screen bg-background"}>
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <ProjectHeroImage
          ...
          className="relative w-full aspect-[16/9] bg-muted overflow-hidden mb-24 rounded-sm"
        />
        ...
        <div className="border-t border-border pt-16 flex flex-col md:flex-row items-center justify-between gap-8">
          {prev ? (
            <Link href={`/projects/${prev.slug}`} scroll={false} className="group flex flex-col gap-2">
          ...
          {next ? (
            <Link href={`/projects/${next.slug}`} scroll={false} className="group flex flex-col gap-2 text-right">
